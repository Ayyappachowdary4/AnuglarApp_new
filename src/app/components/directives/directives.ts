...
@Component({
  ...
  styleUrls: ['./directives.css']  // corrected from styleUrl
})
export class Directives {
  ...
  myStyle1 = { color: 'red', border: '5px dotted green', margin: '20px' };
  myStyle2 = { color: 'purple', border: '5px dotted blue', margin: '10px', padding: '30px' };
